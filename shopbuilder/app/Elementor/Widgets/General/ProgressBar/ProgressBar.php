 ...
 * @package RadiusTheme\SB
 */
class ProgressBar extends ElementorWidgetBase {
	/**
	 * Construct function
	 *
	...
	public function __construct( $data = [], $args = null ) {
		$this->rtsb_name = esc_html__( 'Progress Bar', 'shopbuilder' );
		$this->rtsb_base = 'rtsb-progress-bar-addon';
	...
	public function get_keywords() {
		return [ 'Progress Bar','Progress' ] + parent::get_keywords();
	}
	/**
	 * Style dependencies.
	 *
	...
	protected function render() {
		...
		$template = apply_filters( 'rtsb/general_widget/progress_bar/template', $template, $settings );
		$data     = [
			'template'        => 'elementor/general/progress-bar/' . $template,
			'id'              => $this->get_id(),
